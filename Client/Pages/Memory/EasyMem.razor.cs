...
public class EasyMemBase : ComponentBase
{
    ...
    public void startGame()
    {
        ...
        uniqueCards.Add(new Card() { number = 4, color = "green" });
        uniqueCards.Add(new Card() { number = 5, color = "teal" });
        uniqueCards.Add(new Card() { number = 6, color = "blue" });
        uniqueCards.Add(new Card() { number = 7, color = "purple" });
        uniqueCards.Add(new Card() { number = 8, color = "pink" });
